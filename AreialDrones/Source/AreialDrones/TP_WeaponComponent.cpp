...
void UTP_WeaponComponent::AttachWeapon(AAreialDronesCharacter* TargetCharacter)
{
	...
	m_dronemanager = Cast<ADroneManager>(UGameplayStatics::GetActorOfClass( GetWorld() ,m_dronemanagerbp));
